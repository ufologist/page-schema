...
[ci-status-image]: https://travis-ci.org/ufologist/page-schema.svg?branch=master
[ci-status-url]: https://travis-ci.org/ufologist/page-schema
...
本仓库用于存放基于 AMis 配置出来的页面的配置信息, 例如 [advanced.js](./src/_demo/advanced.js)
